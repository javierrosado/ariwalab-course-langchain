"""L8 · Banca — Banco Inti · app/api.py (checkpoint de referencia)
...
Ejecutar localmente (antes de desplegar), desde la raíz del curso:
    uvicorn modulo-3-produccion.sesion-08-despliegue-hf-spaces.solucion.banca.api:app \
...
app = FastAPI(title="Agente Banco Inti — banca")
