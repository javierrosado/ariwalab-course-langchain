"""L8 · Seguros — Andina Seguros · app/api.py (checkpoint de referencia)
...
Ejecutar localmente (antes de desplegar), desde la raíz del curso:
    uvicorn modulo-3-produccion.sesion-08-despliegue-hf-spaces.solucion.seguros.api:app \
...
app = FastAPI(title="Agente Andina Seguros — seguros")
