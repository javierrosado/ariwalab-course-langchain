"""L8 · Telecomunicaciones — AndesMóvil · app/api.py (checkpoint de referencia)
...
Ejecutar localmente (antes de desplegar), desde la raíz del curso:
    uvicorn modulo-3-produccion.sesion-08-despliegue-hf-spaces.solucion.telecomunicaciones.api:app \
...
app = FastAPI(title="Agente AndesMóvil — telecomunicaciones")
