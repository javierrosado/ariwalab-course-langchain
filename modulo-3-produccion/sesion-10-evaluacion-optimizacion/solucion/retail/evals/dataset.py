"""L10 · Retail — MercaSur · evals/dataset.py (checkpoint de referencia)

Carga las 30 filas de `recursos/golden/consultas-retail.json` y las sube
como Langfuse Dataset. Mismo código que `code/01_dataset_langfuse.py`, ya fijado a
este track.

Ejecutar desde la raíz del curso:
    python modulo-3-produccion/sesion-10-evaluacion-optimizacion/solucion/retail/evals/dataset.py
"""
