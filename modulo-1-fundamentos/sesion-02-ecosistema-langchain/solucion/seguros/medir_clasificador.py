...
Ejecutar desde la raíz del curso:
    python modulo-1-fundamentos/sesion-02-ecosistema-langchain/solucion/seguros/medir_clasificador.py
"""
...
CONSULTAS_PROPIAS: list[tuple[str, str]] = [
    ("¿Cuánto me costaría asegurar mi mototaxi?", "COTIZACION"),
    ("¿Cómo va el trámite del expediente SIN-2026-0099?", "ESTADO_SINIESTRO"),
    ("Choqué recién, hay una persona lesionada, placa XYZ-789", "REPORTE_SINIESTRO"),
    ("¿Mi póliza me cubre hasta fin de año?", "CONSULTA_POLIZA"),
    ("¿El SOAT cubre daños materiales a terceros?", "OTRO"),
]
