"""L7 · Banca — Banco Inti · tests/invariantes.py (checkpoint de referencia)
...
def dice_no_existe(texto: str) -> bool:
    ...
    return menciona_alguna(texto, ["no existe", "no se encuentra", "no está registrad", "verifica el número"])
