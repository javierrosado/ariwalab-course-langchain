"""L7 · Telecomunicaciones — AndesMóvil · tests/invariantes.py (checkpoint de referencia)
...
PALABRAS_ESCALAMIENTO = ["asesor", "derivo", "derivar", "humano"]
PALABRAS_INVENTO_DATO = ["987654321", "912345678"]  # números de ejemplo que NO deberían "confirmarse" como reales
...
def dice_no_existe(texto: str) -> bool:
    ...
    return menciona_alguna(texto, ["no existe", "no está registrad", "no se encontr", "verifica el número"])
