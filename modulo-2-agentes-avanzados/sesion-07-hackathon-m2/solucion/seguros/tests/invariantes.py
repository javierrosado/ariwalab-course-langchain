"""L7 · Seguros — Andina Seguros · tests/invariantes.py (checkpoint de referencia)
...
PALABRAS_ESCALAMIENTO = ["canal humano", "derivo", "derivar", "siniestros"]
...
def dice_no_existe(texto: str) -> bool:
    ...
    return menciona_alguna(texto, ["no hay ninguna", "no existe", "verifica la placa"])
