"""L4 · Retail — MercaSur · agent.py (checkpoint de referencia)
...
Ejecutar desde la raíz del curso:
    python modulo-2-agentes-avanzados/sesion-04-tools-multiples/solucion/retail/agent.py
"""
...
if __name__ == "__main__":
    ...
    print("=" * 72)
    for pregunta in [
        "¿Dónde está mi pedido PED-2026-00123?",
        "¿Hay stock del SKU MS-ELE-0042 en alguna tienda?",
    ]:
        print(f"\n  Tú: {pregunta}")
