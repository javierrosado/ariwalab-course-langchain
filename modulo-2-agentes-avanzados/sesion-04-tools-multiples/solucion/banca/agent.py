"""L4 · Banca — Banco Inti · agent.py (checkpoint de referencia)
...
Ejecutar desde la raíz del curso:
    python modulo-2-agentes-avanzados/sesion-04-tools-multiples/solucion/banca/agent.py
"""
...
if __name__ == "__main__":
    ...
    for pregunta in [
        ...
        "El movimiento MOV-2026-0042 no lo reconozco, ¿es sospechoso?",
    ]:
        print(f"\n  Tú: {pregunta}")
