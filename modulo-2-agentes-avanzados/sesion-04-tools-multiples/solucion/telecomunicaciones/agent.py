"""L4 · Telecomunicaciones — AndesMóvil · agent.py (checkpoint de referencia)

Ensambla las 4 tools de domain_tools.py con el modelo, en un bucle manual
Thought → Action → Observation con tope de iteraciones (regla A4). Mismo patrón que
code/01_multi_tool.py y code/03_tope_iteraciones.py de esta sesión.

Ejecutar desde la raíz del curso:
    python modulo-2-agentes-avanzados/sesion-04-tools-multiples/solucion/telecomunicaciones/agent.py
"""
...
if __name__ == "__main__":
    ...
    for pregunta in [
        ...
        "Quiero reclamar por avería, línea 987654321, llevo 3 días sin servicio",
    ]:
        print(f"\n  Tú: {pregunta}")
