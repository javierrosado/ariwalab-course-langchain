"""L5 · Retail — MercaSur · agent.py v3 (checkpoint de referencia)

Las 4 tools del L4 + el retriever del L5 (RAG agéntico) + memoria por thread_id.

Ejecutar desde la raíz del curso:
    python modulo-2-agentes-avanzados/sesion-05-memoria-rag/solucion/retail/agent.py
"""
...
if __name__ == "__main__":
    ...
    for pregunta in [
        "¿Cuál es la política de devoluciones si mi producto llegó dañado?",  # va al RAG
        "¿Y si ya lo abrí, igual aplica?",                                     # memoria
        "¿Dónde está mi pedido PED-2026-00123?",                              # va a una tool
    ]:
        print(f"\n  Tú: {pregunta}")
