"""L5 · Retail — MercaSur · knowledge/ingest.py (checkpoint de referencia)

Carga los 3 .md del track, los trocea y los indexa en Qdrant Cloud.

Ejecutar desde la raíz del curso (una sola vez por corpus):
    python modulo-2-agentes-avanzados/sesion-05-memoria-rag/solucion/retail/knowledge/ingest.py
"""
...
TRACK = "retail"
CHUNK_SIZE, CHUNK_OVERLAP = 350, 50  # fichas de producto y política de devoluciones: muy breves
...
def main() -> int:
    ...
    try:
        ...
        print("Revisa QDRANT_URL, QDRANT_API_KEY y HF_TOKEN en tu .env, o usa la colección "
              "de respaldo (kb-retail-respaldo) mientras lo resuelves.")
        return 2
