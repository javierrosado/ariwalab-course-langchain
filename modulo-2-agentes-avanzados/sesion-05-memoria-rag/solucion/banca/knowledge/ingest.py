"""L5 · Banca — Banco Inti · knowledge/ingest.py (checkpoint de referencia)

Carga los 3 .md del track, los trocea y los indexa en Qdrant Cloud.

Ejecutar desde la raíz del curso (una sola vez por corpus):
    python modulo-2-agentes-avanzados/sesion-05-memoria-rag/solucion/banca/knowledge/ingest.py
"""
...
TRACK = "banca"
CHUNK_SIZE, CHUNK_OVERLAP = 400, 60  # comisiones y límites: párrafos breves e independientes
...
def main() -> int:
    ...
    try:
        ...
        print("Revisa QDRANT_URL, QDRANT_API_KEY y HF_TOKEN en tu .env, o usa la colección "
              "de respaldo (kb-banca-respaldo) mientras lo resuelves.")
        return 2
