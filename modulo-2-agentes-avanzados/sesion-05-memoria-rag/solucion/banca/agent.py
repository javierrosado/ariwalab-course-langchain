"""L5 · Banca — Banco Inti · agent.py v3 (checkpoint de referencia)

Las 4 tools del L4 + el retriever del L5 (RAG agéntico) + memoria por thread_id.

Ejecutar desde la raíz del curso:
    python modulo-2-agentes-avanzados/sesion-05-memoria-rag/solucion/banca/agent.py
"""
...
if __name__ == "__main__":
    ...
    for pregunta in [
        "¿Cuánto cobra el banco por mantenimiento de cuenta de ahorros?",  # va al RAG
        "¿Y si tengo abono de haberes, igual me cobran?",                   # memoria
        "¿Cuánto tengo en mi cuenta 00112233445566?",                       # va a una tool
    ]:
        print(f"\n  Tú: {pregunta}")
