"""L5 · Seguros — Andina Seguros · knowledge/ingest.py (checkpoint de referencia)

Carga los 3 .md del track, los trocea y los indexa en Qdrant Cloud.

Ejecutar desde la raíz del curso (una sola vez por corpus):
    python modulo-2-agentes-avanzados/sesion-05-memoria-rag/solucion/seguros/knowledge/ingest.py
"""
...
TRACK = "seguros"
CHUNK_SIZE, CHUNK_OVERLAP = 600, 100  # condicionado legal: una cláusula partida pierde su sentido
...
def main() -> int:
    ...
    try:
        ...
        print("Revisa QDRANT_URL, QDRANT_API_KEY y HF_TOKEN en tu .env, o usa la colección "
              "de respaldo (kb-seguros-respaldo) mientras lo resuelves.")
        return 2
